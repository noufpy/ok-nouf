...
for f in files:
    ...
    document = open("corpus/" + f,'r').readlines()
    #print("-- file loaded")
...
## spacy load: questions
# for i in document[::2]:
#     sentence = nlp(i.decode('utf8'))
#     questions.append(sentence)
      #questions_str.append(unicode(i, "utf-8"))
#print("-- questions vectorized")
## spacy load: answers
# for i in document[1::2]:
#     sentence = nlp(i.decode('utf8'))
#     answers.append(sentence)
#     #answers_str.append(str(sentence))
#     answers_str.append(unicode(i, "utf-8"))
#print("-- answers vectorized")
